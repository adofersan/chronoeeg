...
import numpy as np
import pandas as pd
from chronoeeg.exceptions import DataValidationError, ChannelMismatchError
...
class AdvancedValidator:
    ...
    def validate_channels(
        ...
        if expected_channels is not None:
            ...
            if extra:
                raise ChannelMismatchError(
                    f"Unexpected channels found: {extra}"
                )
    ...
    def validate_no_constant_channels(
        ...
        if constant_channels:
            raise DataValidationError(
                f"Constant channels detected: {constant_channels}"
            )
