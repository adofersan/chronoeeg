...
class TestCompleteWorkflow:
    ...
    def test_full_pipeline(self, synthetic_eeg):
        ...
        classical_cols = [col for col in results['features'].columns 
    ...
    def test_manual_workflow(self, synthetic_eeg):
        ...
        # Step 4: Extract features from first good epoch
        ...
        # FMM features
        fmm_extractor = FMMFeatureExtractor(n_components=3, sampling_rate=128)
    ...
    def test_parallel_processing(self, synthetic_eeg):
        ...
        chunks = [
            synthetic_eeg.iloc[i:i+chunk_size]
            for i in range(0, len(synthetic_eeg), chunk_size)
        ]
        ...
        results = processor.process_parallel(process_chunk, chunks)
    ...
    def test_error_handling(self):
        ...
        with pytest.raises(Exception):
            EpochExtractor(epoch_duration=300, sampling_rate=0)
